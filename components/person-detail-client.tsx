      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-10 md:px-16">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[280px_1fr] lg:gap-16">
            ...
            <div className="mt-8 w-full space-y-4 text-sm text-zinc-300">
              ...
              {person.popularity !== undefined && (
                <div>
                  ...
                  <span className="mt-1 flex items-center justify-center gap-1.5 md:justify-start">
          ...
          <div className="flex flex-col gap-8">
            ...
            {/* Filmography Section */}
            <div>
              <div className="mb-6 flex flex-col gap-4 border-b border-zinc-800/80 pb-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  {/* Media Type Filter */}
                  <div className="flex items-center gap-1 rounded-xl border border-zinc-800/40 bg-zinc-900/60 p-1">
                    <button
                  ...
                  >
                    <SelectTrigger className="h-9 rounded-xl border border-zinc-800/40 bg-zinc-900/60 px-3 text-xs font-semibold text-zinc-300 outline-none hover:text-white">
                      <SelectValue>
                    ...
                    <SelectContent className="rounded-xl border border-zinc-800 bg-zinc-900 text-white shadow-xl">
                      <SelectGroup>
                        <SelectItem
                          value="popularity"
                          className="hover:bg-zinc-850 cursor-pointer rounded-lg px-3 py-2 text-xs text-zinc-300 hover:text-white focus:bg-zinc-800 focus:text-white"
                        >
                          Popularity
                        </SelectItem>
                        <SelectItem
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                  {filteredAndSortedCredits.map((item) => (
                    ...
                    >
                      ...
                      {item.roleLabel && (
                        <span
                          className="line-clamp-2 px-1 text-center text-[10px] leading-tight text-zinc-500"
